<template>
  <div class="bigBox" >
    ...
    <div class="totalHeader">
      <div class="ecology">
        <h1 class="echo gonggongH1">e-cology</h1>
        <h1 class="prep gonggongH1">丨前端用户中心</h1>
      </div>
      <div class="titleList">
        <ul class="doorList">
          <li style="color: white">门户</li>
          <li class="gonggongl" title="我的流程">流程</li>
          <li class="gonggongl" title="我的知识">知识</li>
          <li class="gonggongl" title="我的协作">协作</li>
          <li class="gonggongl" title="我的日程">日程</li>
        </ul>
    ...
    <div class="closehide" v-show="closehide">
      ...
      <div class="bottombox">
        <h2  class="confirm">确认</h2>
        <h2 @click="closebut()" class="delete">取消</h2>
      </div>
    </div>
    <div class="totalLeft">
      <div class="name">
        <h1 class="gonggongH1" style="cursor: pointer" title="这是一个小傻b">小小肖</h1>
      </div>
      <ul class="funList">
        <li class="doorUser gonggongH1">门户</li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2"></i>
          <h2 class="gonggongH2" title="个人门户">个人门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2"></i>
          <h2 class="gonggongH2"  title="公司门户">公司门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2" ></i>
          <h2 class="gonggongH2" title="高管门户">高管门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2" ></i>
          <h2 class="gonggongH2" title="营销门户">营销门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2" ></i>
          <h2 class="gonggongH2"  title="项目门户">项目门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2" ></i>
          <h2 class="gonggongH2" title="客服门户" >客服门户</h2>
        </li>
        <li class="gogos">
          <i class="iconfont icon-buju_biaoti gonggongH2" ></i>
          <h2 class="gonggongH2" title="报表门户">报表门户</h2>
        </li>
      </ul>
      <div class="mesBoxD" >
        <p class="mesBoxP"><span >新到达消息提示</span> <span style="font-size: 18px">×</span></p>
      ...
      <div class="mesBox">
        <i class="iconfont icon-laba" @click="showleft"></i>
...
export default {
  ...
  methods: {
    showleft: function () {
      document.querySelector('.mesBoxD').style.display = 'block'
      this.fnc = !this.fnc
      if (this.fnc == false) {
        document.querySelector('.mesBoxD').style.top = '85%'
        document.querySelector('.mesBoxD').style.display = 'none'
        return
      }
      let top1 = 85
      let timer1 = setInterval(() => {
        ...
        document.querySelector('.mesBoxD').style.top = top1 + '%'
        console.log(top1)
      }, 10)
    },
    showsou: function () {
